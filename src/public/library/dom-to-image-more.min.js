...
((l) => {
    let f = (() => {
            ...
            return {
                ...
                getAndEncode: function (s) {
                    ...
                    e || ((e = { url: s, promise: null }), a.impl.urlCache.push(e));
                    null === e.promise &&
                        (a.impl.options.cacheBust && (s += (/\?/.test(s) ? '&' : '?') + new Date().getTime()),
                        (e.promise = new Promise(function (t) {
                            ...
                            if (
                                ((r.onreadystatechange = function () {
                                    if (4 === r.readyState)
                                        if (300 <= r.status)
                                            n ? t(n) : l(`cannot fetch resource: ${s}, status: ` + r.status);
                                        else {
                                ...
                                (r.responseType = 'blob'),
                                (r.timeout = e),
                                0 < a.impl.options.useCredentialsFilters.length &&
                                    (a.impl.options.useCredentials =
                                        0 <
                                        a.impl.options.useCredentialsFilters.filter((e) => 0 <= s.search(e)).length),
                                a.impl.options.useCredentials && (r.withCredentials = !0),
                                a.impl.options.corsImg &&
                                    0 === s.indexOf('http') &&
                                    -1 === s.indexOf(window.location.origin))
                            ) {
                                var i =
                                    'POST' === (a.impl.options.corsImg.method || 'GET').toUpperCase() ? 'POST' : 'GET';
                                r.open(i, (a.impl.options.corsImg.url || '').replace('#{cors}', s), !0);
                                let t = !1,
                                    n = a.impl.options.corsImg.headers || {},
                                    o =
                                        (Object.keys(n).forEach(function (e) {
                                            (-1 !== n[e].indexOf('application/json') && (t = !0),
                            ...
                            a.impl.options.imagePlaceholder &&
                                (i = a.impl.options.imagePlaceholder.split(/,/)) &&
                                i[1] &&
                                (n = i[1]);
                        })));
                    return e.promise;
                ...
                makeImage: function (o) {
                    return 'data:,' !== o
                        ? new Promise(function (e, t) {
                              let n = new Image();
                              (a.impl.options.useCredentials && (n.crossOrigin = 'use-credentials'),
                                  (n.onload = function () {
        ...
        r = (() => {
            ...
            function i(n, o, t, e) {
                return Promise.resolve(o)
                    ...
                    .then(function (e) {
                        return n.replace(
                            ((t = o), new RegExp(`(url\\(['"]?)(${f.escape(t)})(['"]?\\))`, 'g')),
                            `$1${e}$3`
                        );
                        var t;
                    });
    ...
    function t() {
        return Promise.resolve(f.asArray(document.styleSheets))
            .then(function (e) {
                ...
                return (
                    e.forEach(function (t) {
                        if (Object.prototype.hasOwnProperty.call(Object.getPrototypeOf(t), 'cssRules'))
                            try {
    ...
    let s = {
        ...
        a = {
            ...
            toCanvas: i,
            impl: { fontFaces: e, images: n, util: f, inliner: r, urlCache: [], options: {} },
        },
        c =
            ('object' == typeof exports && 'object' == typeof module ? (module.exports = a) : (l.domtoimage = a),
            ('undefined' != typeof Node ? Node.ELEMENT_NODE : void 0) || 1),
        m =
            (void 0 !== l ? l.getComputedStyle : void 0) ||
            ('undefined' != typeof window ? window.getComputedStyle : void 0) ||
            globalThis.getComputedStyle,
        u =
            (void 0 !== l ? l.atob : void 0) ||
    ...
    function d(e, r) {
        ...
        (void 0 === n.copyDefaultStyles
            ? (a.impl.options.copyDefaultStyles = s.copyDefaultStyles)
            : (a.impl.options.copyDefaultStyles = n.copyDefaultStyles),
            (a.impl.options.imagePlaceholder = (void 0 === n.imagePlaceholder ? s : n).imagePlaceholder),
            (a.impl.options.cacheBust = (void 0 === n.cacheBust ? s : n).cacheBust),
            (a.impl.options.corsImg = (void 0 === n.corsImg ? s : n).corsImg),
            (a.impl.options.useCredentials = (void 0 === n.useCredentials ? s : n).useCredentials),
            (a.impl.options.useCredentialsFilters = (void 0 === n.useCredentialsFilters ? s : n).useCredentialsFilters),
            (a.impl.options.httpTimeout = (void 0 === n.httpTimeout ? s : n).httpTimeout),
            (a.impl.options.styleCaching = (void 0 === n.styleCaching ? s : n).styleCaching));
        let i = [];
        return Promise.resolve(e)
            .then(function (e) {
                ...
                return (n.replaceChild(o, t), o.append(e), i.push({ parent: n, child: t, wrapper: o }), o);
            })
            .then(function (e) {
                return (function l(t, s, r, u) {
                    ...
                    function d(u, a) {
                        return !f.isElement(u) || f.isShadowSlotElement(a)
                            ? Promise.resolve(u)
                            : Promise.resolve()
                                  .then(e)
                                  .then(t)
                        ...
                        function e() {
                            function o(e, t) {
                                ((t.font = e.font),
                                    ...
                                    (t.fontFeatureSettings = e.fontFeatureSettings),
                                    ...
                                    (t.fontVariantEastAsian = e.fontVariantEastAsian),
                                    (t.fontVariantLigatures = e.fontVariantLigatures),
                                    (t.fontVariantNumeric = e.fontVariantNumeric),
                                    (t.fontVariationSettings = e.fontVariationSettings),
                                    (t.fontWeight = e.fontWeight));
                            }
                            function e(e, t) {
                                let n = m(e);
                                n.cssText
                                    ? ((t.style.cssText = n.cssText), o(n, t.style))
                                    : (y(s, e, n, r, t),
                                      null === r &&
                                          (['inset-block', 'inset-block-start', 'inset-block-end'].forEach((e) =>
                        ...
                        function n() {
                            (f.isHTMLTextAreaElement(a) && (u.innerHTML = a.value),
                                f.isHTMLInputElement(a) && u.setAttribute('value', a.value));
                        }
                        function o() {
                            f.isSVGElement(u) &&
                                (u.setAttribute('xmlns', 'http://www.w3.org/2000/svg'), f.isSVGRectElement(u)) &&
            ...
            .then(r.disableEmbedFonts ? Promise.resolve(e) : p)
            .then(g)
            .then(function (t) {
            ...
            .then(function (e) {
                ...
                return Promise.resolve(e)
                    ...
                    .then(function (e) {
                        var t =
                            (f.isDimensionMissing(n) ? ' width="100%"' : ` width="${n}"`) +
                            (f.isDimensionMissing(o) ? ' height="100%"' : ` height="${o}"`);
            ...
            .then(function (e) {
                var t = 'number' != typeof i.scale ? 1 : i.scale,
                    n = ((e, t) => {
                        ...
                        return (
                            f.isDimensionMissing(n) && (n = f.isDimensionMissing(o) ? 300 : 2 * o),
                            f.isDimensionMissing(o) && (o = n / 2),
                            ((e = document.createElement('canvas')).width = n * t),
                            (e.height = o * t),
                            i.bgcolor &&
                                (((t = e.getContext('2d')).fillStyle = i.bgcolor), t.fillRect(0, 0, e.width, e.height)),
                            e
                        );
                    })(r, t),
                    o = n.getContext('2d');
    ...
    function y(e, t, i, l, n) {
        let s = a.impl.options.copyDefaultStyles
                ? ((t, e) => {
                      var n,
                          o = ((e) =>
                              ('relaxed' !== t.styleCaching
                                  ? e
                                  : e.filter((e, t, n) => 0 === t || t === n.length - 1)
                              ).join('>'))(
                              (e = ((e) => {
                                  var t = [];
                                  do {
                          ...
                          );
                      {
                          ...
                          ((e = ((e, t) => {
                              ...
                              (n = (() => {
                                  ...
                                  ((t = document.characterSet || 'UTF-8'),
                                      (e = (e = document.doctype)
                                          ? (`<!DOCTYPE ${s(e.name)} ${s(e.publicId)} ` + s(e.systemId)).trim() + '>'
                                          : ''),
                                      ((h = document.createElement('iframe')).id = 'domtoimage-sandbox-' + f.uid()),
                                  ...
                                  try {
                                      return (
                                          n.contentWindow.document.write(
                                              e +
                                                  `<html><head><meta charset='${t}'><title>${o}</title></head><body></body></html>`
                                          ),
                                          n.contentWindow
                                      );
                                  } catch (e) {}
                                  ...
                                  return (
                                      n.contentDocument.head.appendChild(r),
                                      (n.contentDocument.title = o),
                                      n.contentWindow
                                  );
                                  function s(e) {
                                      var t;
                                      return e
                                          ? (((t = document.createElement('div')).innerText = e), t.innerHTML)
                                          : '';
                                  }
                              })()).document,
                              e
        ...
        f.asArray(i).forEach(function (e) {
            ...
            u.getPropertyValue(e) ||
                ((n !== o || (l && n !== r)) &&
                    ...
                    o
                        ? (r.setProperty(e, n, o), t && r.setProperty('-webkit-' + e, n, o))
                        : (r.setProperty(e, n), t && r.setProperty('-webkit-' + e, n))));
        });
    }
    let w = null,
        v = {},
